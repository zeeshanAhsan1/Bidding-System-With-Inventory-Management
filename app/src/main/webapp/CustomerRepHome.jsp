	...
	<h2>Bids and Auctions</h2>
		...
		%>
			<tr>
				...
				<% String mysubcat = null;
					if( resultset.getString(3).equals("Figurines")){
						mysubcat = "Kitchenware";
					}else if(resultset.getString(3).equals("Cars")){
						mysubcat = "Bathroomware";
					}else{
						mysubcat = "Roomware";
					}
				...
				<td style="max-width: 300px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;"><%= mysubcat %></td>
