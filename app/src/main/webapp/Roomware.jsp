...
<body>
  ...
  <form class="form-inline" method="post" action="search.jsp?subcat=Roomware">
	...
	<form class="form-inline" method="post" action="Roomware.jsp">
