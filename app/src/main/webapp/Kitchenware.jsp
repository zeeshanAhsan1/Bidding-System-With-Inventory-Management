...
<div class="container">
	<form class="form-inline" method="post" action="search.jsp?subcat=Kitchenware">
	...
	<form class="form-inline" method="post" action="Kitchenware.jsp?">
