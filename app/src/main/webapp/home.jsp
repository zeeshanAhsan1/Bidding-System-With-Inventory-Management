...
<body>
    ...
    <div style="text-align: center">
        <h1>Welcome to Furniture Auctioning</h1>
       
       <table style="margin: 0px auto;">
		<tr>
			<td><a href="Kitchenware.jsp">Kitchenware</a></td>
			<td>|</td>
			<td><a href="Bathroomware.jsp">Bathroomware</a></td>
			<td>|</td>
			<td><a href="Roomware.jsp">Roomware</a></td>
		</tr>
		</table>
